...
class MusicPlayerSmokeTest {
    ...
    fun playback_state_copy_updates_correctly() {
        ...
        val playing = initial.copy(trackId = 42L, isPlaying = true, durationMs = 30_000L)
    ...
    fun playback_state_equality_works_correctly() {
        val state1 = PlaybackState(trackId = 1L, isPlaying = true)
        val state2 = PlaybackState(trackId = 1L, isPlaying = true)
        val state3 = PlaybackState(trackId = 2L, isPlaying = false)
